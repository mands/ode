...
-- TODO - questions
-- how does interpetation work, is strict, hence order determined by pos in file
...
data Module =    ClosedModule {model :: OrdModel TypedId, signature :: Map.Map SrcId Type, topIdsBimap :: IdBimap, lastUsedId :: UntypedId  }
                 -- | Functor {model :: OrdModel TypedId, signature :: Map.Map SrcId Type, args :: [ExeModule], topIdsBimap :: IdBimap, lastUsedId :: UntypedId }
                 ...
                 | AppModule { name:: SrcId,  functor:: SrcId, args :: [SrcId]}
...
type ModuleEnv = Map.Map SrcId Module

--createModule :: ModelMap TypedId -> IdBimap -> ExeModule
