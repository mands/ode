...
module Ode.Subsystem.Simulation.JITCompiler.JITHybridSolver (
genHybridSolver
) where
...
import Ode.Subsystem.Simulation.JITCompiler.JITDiffSolvers
import Ode.Subsystem.Simulation.JITCompiler.JITSolver(createSimParams, writeOutData)
