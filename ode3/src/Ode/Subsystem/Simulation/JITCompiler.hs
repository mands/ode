...
module Ode.Subsystem.Simulation.JITCompiler (
compileAndSimulate
) where
...
import Ode.Subsystem.Simulation.JITCompiler.JITSolver
import Ode.Subsystem.Simulation.JITCompiler.JITShell
import Ode.Subsystem.Simulation.JITCompiler.JITModel(genModelInitials, genModelRHS)
import Ode.Subsystem.Simulation.JITCompiler.JITHybridSolver
